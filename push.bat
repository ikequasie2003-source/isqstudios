...
"C:\Program Files\Git\cmd\git.exe" -C "C:\Users\QUASIE\Documents\isqstudios-main" commit -m "Homepage redesign, animated tees/caps sections, admin password update, shop category routing"
