...
"C:\Program Files\Git\cmd\git.exe" -C "C:\Users\QUASIE\Documents\isqstudios-main" commit -m "Admin dashboard redesign, inventory reset to zero, glassmorphic UI, simplified table"
