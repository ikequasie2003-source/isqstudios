        ...
        <main className="mx-auto max-w-[1400px] px-6 py-24 text-white lg:px-14 lg:py-32">
          ...
          <div className="mt-12 grid grid-cols-1 gap-16 md:grid-cols-2">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-xs uppercase tracking-[0.24em] text-[#C9A227]/70">Processing Time</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#F7F4EE]/80">
                  All orders are processed within 2–4 business days. You'll receive a confirmation email once your order ships.
                </p>
              </div>
              <div>
                <h3 className="text-xs uppercase tracking-[0.24em] text-[#C9A227]/70">Domestic Shipping</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#F7F4EE]/80">
                  Standard delivery takes 5–7 business days. Express options are available at checkout.
                </p>
              </div>
              <div>
                <h3 className="text-xs uppercase tracking-[0.24em] text-[#C9A227]/70">International Shipping</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#F7F4EE]/80">
              ...
              <div>
                <h3 className="text-xs uppercase tracking-[0.24em] text-[#C9A227]/70">Tracking</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#F7F4EE]/80">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-xs uppercase tracking-[0.24em] text-[#C9A227]/70">Returns Policy</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#F7F4EE]/80">
              ...
              <div>
                <h3 className="text-xs uppercase tracking-[0.24em] text-[#C9A227]/70">How To Return</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#F7F4EE]/80">
                  Email us at <a href="mailto:ikequasie2003@gmail.com" className="underline text-[#C9A227]/80 hover:text-[#B08B1E] transition-colors">ikequasie2003@gmail.com</a> with your order number and reason for return. We'll send you return instructions within 48 hours.
                </p>
              </div>
              <div>
                <h3 className="text-xs uppercase tracking-[0.24em] text-[#C9A227]/70">Refunds</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#F7F4EE]/80">
              ...
              <div>
                <h3 className="text-xs uppercase tracking-[0.24em] text-[#C9A227]/70">Exchanges</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#F7F4EE]/80">
